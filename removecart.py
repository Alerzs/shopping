...
class ProductManager:  
    ...
    def rate_menu(self):  
        if self.shoping_cart:  
            self.show_cart()  
            product = input("if you want to rate enter product's number. To quit enter 0: ")  
            if product == "0":  
                return  
...
while True:  
    ...
    print("Press 'N' to search by product name")  
    ...
    if inp == 'F':  
        ...
        if price:  
            ...
            inp = input("press 'P' to submit your order and pay: ")  
            if inp.upper() == 'P':  
                manage.save()  
                print("your order was submitted.")  
